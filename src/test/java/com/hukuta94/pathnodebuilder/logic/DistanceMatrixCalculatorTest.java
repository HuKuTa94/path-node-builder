...
public class DistanceMatrixCalculatorTest
{
    ...
    void optimizedDistanceMatrixTest()
    {
        ...
        float[][] expectedDistanceMatrix = new float[][]
            {
                {1.001f, 2.002f, 2.002f, 2.002f, 1.001f, 1.001f, 2.002f},
                {1.001f, 2.002f, 3.003f, 2.002f, 2.002f, 3.003f},
                {1.001f, 2.002f, 3.003f, 2.002f, 3.003f},
                {1.001f, 2.002f, 1.001f, 2.002f},
                {1.001f, 2.002f, 1.001f},
                {2.002f, 1.001f},
                {1.001f},
            };
