...
import com.hukuta94.pathnodebuilder.overwatch.filter.OverwatchGlobalVariables.INPUT_NODE_CONNECTIONS_VAR_NAME
import com.hukuta94.pathnodebuilder.overwatch.filter.OverwatchGlobalVariables.INPUT_NODE_POSITIONS_VAR_NAME
import java.util.function.Function

class IncomingSnippetParserFilter : Function<String, GlobalvariablesDto> {

    override fun apply(rawData: String): GlobalvariablesDto {
        if (rawData.isBlank()) {
